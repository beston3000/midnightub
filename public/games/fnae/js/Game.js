    ...
    showTutorial(type = 'night1') {
        ...
        if (type === 'night2') {
            ...
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST CRISPY</h2>
                <p>
                    CRISPY WILL TRY TO ATTACK YOU THROUGH THE VENTS IN CAM 1 AND CAM 2, SO IF YOU HEAR BANGING IN THE VENTS HEAD OVER TO THE CONTROL PANEL AND CLOSE THEM. 
                    ...
                    CRISPY CAN BE LURED WITH THE AUDIOS BUT YOUR MAIN PRIORITY WITH THE AUDIO LURES SHOULD BE EPSTEIN.
                </p>
            ...
            // Night 1 教程：EP
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST CRISPY'S BROTHER</h2>
                <p>
                    CRISPY'S BROTHER ALWAYS STARTS AT CAM 11. USE THE CAMERA'S AUDIO LURE TO KEEP CRISPY'S BROTHER FAR AWAY FROM YOU. 
                    MAKE SURE THE CAMERA YOU'RE PLAYING THE SOUND IN IS NEXT TO THE CAMERA WHERE CRISPY'S BROTHER IS. 
                    ...
                    CRISPY'S BROTHER DOES NOT ATTACK THROUGH THE VENTS SO DON'T BOTHER CLOSING THEM FOR THIS NIGHT.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
